      ...
      <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-xl mx-auto py-16 sm:py-24">
          <div className="text-center">
            <p className="text-medium font-semibold text-white uppercase tracking-wide">404 error</p>
            <h1 className="mt-2 text-4xl font-extrabold text-green-400 tracking-tight sm:text-5xl">
              This page does not exist.
            </h1>
            <p className="mt-2 text-lg text-white">The page you are looking for could not be found.</p>
          </div>
          <div className="mt-12">
            <h2 className="text-sm font-semibold text-green-400 tracking-wide uppercase">Popular pages</h2>
              ...
              {links.map((link, linkIdx) => (
                <li key={linkIdx} className="relative py-6 flex items-start space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-base font-medium text-green-400 hover:text-white">
                    ...
                    <p className="text-base text-white">{link.description}</p>
                  </div>
            ...
            <div className="mt-8">
              <a href="#" className="text-base font-medium text-green-400 hover:text-white">
