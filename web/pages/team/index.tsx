...
const people = [
    {
      ...
      imageUrl:
        'ryan.png',
      twitterUrl: 'https://www.twitter.com/RyChrome',
      linkedinUrl: 'https://www.linkedin.com/in/ryanallendils',
    },
    {
      name: 'Nick Minor',
      role: 'Junior',
        ...
        <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
          <div className="space-y-12">
            <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
              <h2 className="text-3xl font-extrabold text-green-400 tracking-tight sm:text-4xl">Meet our team</h2>
              <p className="text-xl text-white">
                The team for UB Hacking 2021
              </p>
            </div>
                  ...
                  <div className="space-y-6 xl:space-y-10">
                    ...
                    <div className="space-y-2 xl:flex xl:items-center xl:justify-between">
                      <div className="font-medium text-lg leading-6 space-y-1">
                        <h3 className="text-emerald-800">{person.name}</h3>
